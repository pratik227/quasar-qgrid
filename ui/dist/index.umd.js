  ...
  var render = /*#__PURE__*/_withId(function (_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (vue.openBlock(), vue.createBlock("span", null, [
      vue.createVNode(_component_q_table, {
        ...
        "onUpdate:selected": _cache[7] || (_cache[7] = function ($event) { return (_ctx.selected_prop = $event); }),
        filter: _ctx.filter
      }, vue.createSlots({
          ...
          vue.withDirectives(vue.createVNode(_component_q_tr, { props: props }, {
            default: _withId(function () { return [
              (_ctx.selection_prop!='none')
                ...
                : vue.createCommentVNode("", true),
              (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(props.cols, function (col) {
                return (vue.openBlock(), vue.createBlock(_component_q_th, {
                  props: props,
                  onHover: _cache[2] || (_cache[2] = vue.withModifiers(function () {}, ["stop"])),
                  key: col.name
                }, {
                  default: _withId(function () { return [
                    vue.createVNode("div", _hoisted_1, [
                      vue.createVNode("div", _hoisted_2, [
                        vue.createVNode("p", null, vue.toDisplayString(col.label), 1)
                      ]),
        ...
        body: _withId(function (props) { return [
          (!_ctx.hasDefaultSlot)
            ? (vue.openBlock(), vue.createBlock(_component_q_tr, {
                key: 0,
                props: props
                ...
                default: _withId(function () { return [
                  (_ctx.selection_prop!='none')
                    ...
                    : vue.createCommentVNode("", true),
                  (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(props.cols, function (col, col_index) {
                    ...
                    default: _withId(function () { return [
                      vue.createVNode(_component_q_table, {
                        ...
                        default: _withId(function () { return [
                          vue.createVNode(_component_q_tr, {
                            ...
                            default: _withId(function () { return [
                              (_ctx.col.field!=_ctx.selected_group_by_filed)
                                ? (vue.openBlock(true), vue.createBlock(vue.Fragment, { key: 0 }, vue.renderList(props.cols, function (col) {
                                    return (vue.openBlock(), vue.createBlock(_component_q_th, {
                                      key: col.name,
                                      props: props
                                    }, {
                          ...
                          vue.createVNode("template", _hoisted_5, [
        ...
        (_ctx.excel_download || _ctx.csv_download || _ctx.fullscreen || _ctx.global_search)
          ? {
              name: "top-right",
              fn: _withId(function (props) { return [
                (_ctx.global_search)
                  ? (vue.openBlock(), vue.createBlock(_component_q_input, {
                      key: 0,
                      filled: "",
                ...
                (_ctx.excel_download)
                  ? (vue.openBlock(), vue.createBlock(_component_q_btn, {
                      ...
                      "no-caps": "",
                      onClick: _cache[4] || (_cache[4] = function ($event) { return (_ctx.exportTable('xlsx')); })
                    }))
                  : vue.createCommentVNode("", true),
                (_ctx.csv_download)
                  ? (vue.openBlock(), vue.createBlock(_component_q_btn, {
                      ...
                      "no-caps": "",
                      onClick: _cache[5] || (_cache[5] = function ($event) { return (_ctx.exportTable('csv')); })
                    }))
                  : vue.createCommentVNode("", true),
                (_ctx.groupby_filter)
                  ? (vue.openBlock(), vue.createBlock(_component_q_select, {
                      ...
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = function ($event) { return (_ctx.selected_group_by_filed = $event); }),
                ...
                (_ctx.fullscreen)
                  ? (vue.openBlock(), vue.createBlock(_component_q_btn, {
                      ...
                      default: _withId(function () { return [
                        vue.withDirectives(vue.createVNode(_component_q_tooltip, {
