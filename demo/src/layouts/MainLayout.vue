      ...
      <q-list>
        ...
        >
          <q-card class="bg-transparent">
            ...
            <q-item class="text-primary q-ml-md" :active-class="$route.path=='/example-qgrid-draggable-columns-slot'?'bg-grey-3':''" to="/example-qgrid-draggable-columns-slot" dense clickable>
              <q-item-section>
