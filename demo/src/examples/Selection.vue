  ...
  <q-card :class="!$q.dark.isActive?'my-lg q-pa-md q-ma-sm bg-grey-2':'my-lg q-pa-md q-ma-sm bg-grey-8'">
    <q-toolbar>
      ...
      >
        ...
        ><span class="ellipsis">Selection</span></q-toolbar-title>
      </q-ribbon>
    </q-toolbar>
    ...
    <q-card-section>
      ...
      <q-grid :data="data" :columns="columns" :columns_filter="true" :draggable="true" selection="multiple" :csv_download="true" file_name="sample"
              :selected="selected"
